...
import { FaPhoneAlt, FaTimes, FaCommentDots, FaArrowUp, FaStar, FaCheckCircle } from "react-icons/fa";
...
const navLinks = [
  ...
  { name: "Combo Packages", href: "/combo-packages", active: true },
      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ color: "#fff", margin: "5px 0 0", fontSize: "13px", opacity: 0.9 }}>
...
// ==================== COMBO PACKAGES HERO (Responsive) ====================
  ...
  return (
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          .combo-hero { padding: 60px 20px 100px !important; }
        ...
        @media (min-width: 769px) and (max-width: 1024px) {
          .combo-hero { padding: 70px 30px 120px !important; }
...
// ==================== COMBO PACKAGES LIST SECTION (Responsive) ====================
function ComboPackagesList() {
  ...
  if (error) {
    return (
      <section style={{ background: "#f8f9ff", padding: "90px 40px 100px", fontFamily: "'Nunito', sans-serif", textAlign: "center" }}>
        ...
        <button
          onClick={() => fetchComboPackages()}
          style={{ marginTop: 20, background: "#e22222", color: "#fff", border: "none", padding: "10px 20px", borderRadius: 6, cursor: "pointer" }}
        >
          Try Again
        </button>
      </section>
  ...
  return (
    <section style={{ background: "#f8f9ff", padding: "90px 40px 100px", fontFamily: "'Nunito', sans-serif" }}>
      <style>{`
        @keyframes comboFadeIn { from { opacity: 0; transform: translateY(30px); } to { opacity: 1; transform: translateY(0); } }
        .combo-card { animation: comboFadeIn 0.5s ease both; }
        .combo-card:hover { transform: translateY(-8px); box-shadow: 0 20px 40px rgba(0,0,0,0.15); }
        @media (max-width: 768px) {
            ...
            return (
              <div key={pkg._id} className="combo-card" style={{ animationDelay: `${index * 0.1}s` }}>
                ...
                >
                  {/* Header */}
                  <div
                    className="combo-card-header"
                    style={{
                      background: "linear-gradient(135deg, #e22222 0%, #b71c1c 100%)",
                      padding: "20px 24px",
                      position: "relative",
                    }}
                  >
