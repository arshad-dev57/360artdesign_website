...
import { FaPhoneAlt, FaTimes, FaArrowUp, FaCommentDots } from "react-icons/fa";
  ...
  return (
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          .packages-hero { padding: 60px 20px 100px !important; }
        ...
        @media (min-width: 769px) and (max-width: 1024px) {
          .packages-hero { padding: 70px 30px 120px !important; }
      ...
      >
        ...
        >
          ...
          <div className="hero-buttons" style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <button className="pkg-hero-btn-primary" style={{ background: "#e22222", color: "#fff", border: "none", padding: "14px 38px", fontWeight: 800, cursor: "pointer", borderRadius: 6, fontSize: 16, fontFamily: "'Nunito', sans-serif", transition: "background 0.3s ease" }}>
              View All Plans
            </button>
            <button className="pkg-hero-btn-outline" style={{ background: "transparent", color: "#fff", border: "2px solid rgba(255,255,255,0.85)", padding: "12px 34px", fontWeight: 700, cursor: "pointer", borderRadius: 6, fontSize: 16, fontFamily: "'Nunito', sans-serif", transition: "all 0.3s ease" }}>
              Talk To Expert
            </button>
          </div>
        </div>

        {/* Waves — sirf client pe render hongi */}
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 120, lineHeight: 0, zIndex: 2, overflow: "hidden", pointerEvents: "none" }}>
        ...
        {pricingCategories.map((cat) => (
          <button
            ...
            style={{
              ...
              borderRadius: 50,
              fontSize: 14,
              fontWeight: activeTab === cat.key ? 800 : 600,
              fontFamily: "'Nunito', sans-serif",
              background: activeTab === cat.key ? "#e22222" : "transparent",
              color: activeTab === cat.key ? "#fff" : "#555",
              transition: "all 0.25s ease",
              boxShadow: activeTab === cat.key ? "0 4px 16px rgba(226,34,34,0.4)" : "none",
              whiteSpace: "nowrap",
            }}
          >
            {cat.label}
      ...
      <div className="testimonials-section">
        <div
          style={{
            ...
            right: 0,
            height: "400px",
            background: "radial-gradient(circle at 0% 0%, rgba(226,34,34,0.08) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
          style={{
            ...
            width: "500px",
            height: "500px",
            background: "radial-gradient(circle, rgba(226,34,34,0.04) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", position: "relative", zIndex: 2 }}>
          <div style={{ textAlign: "center", marginBottom: 70 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 20 }}>
              ...
              <span style={{ fontSize: 13, fontWeight: 700, letterSpacing: "4px", color: "#e22222", textTransform: "uppercase" }}>
                Testimonials
              </span>
              <span style={{ width: 50, height: 2, background: "#e22222" }} />
            </div>
          ...
          <div style={{ maxWidth: 1000, margin: "0 auto" }}>
            <div
              ...
              style={{
                background: "#fff",
                borderRadius: 32,
                boxShadow: "0 30px 60px rgba(0,0,0,0.08), 0 10px 30px rgba(0,0,0,0.04)",
                overflow: "hidden",
                transition: "all 0.3s ease",
                position: "relative",
              }}
                ...
                <div className="testimonial-author" style={{ display: "flex", alignItems: "center", gap: 20, marginBottom: 30, flexWrap: "wrap" }}>
                  <div
                    style={{
                      ...
                      fontWeight: 700,
                      fontSize: 24,
                      boxShadow: "0 8px 20px rgba(226,34,34,0.3)",
                    }}
                  >
              ...
              >
                <button
                  ...
                  onMouseEnter={(e) => {
                    ...
                    const a = e.currentTarget.querySelector("svg");
                    if (a) (a as SVGElement).style.stroke = "#fff";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = "#fff";
                    e.currentTarget.style.borderColor = "#e0e0e0";
                    const a = e.currentTarget.querySelector("svg");
                    if (a) (a as SVGElement).style.stroke = "#333";
                  }}
                >
