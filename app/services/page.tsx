...
export function Header() {
  ...
  const handleServiceClick = (serviceName: string, href: string, sectionId: string) => {
    console.log('Header handleServiceClick called:', { serviceName, sectionId, pathname });
    ...
    if (element) {
      ...
      console.log('Element not found, navigating to services page');
...
export function FooterSection() {
  ...
  const handleServiceClick = (serviceName: string, sectionId: string) => {
    console.log('handleServiceClick called:', { serviceName, sectionId, pathname });
    const element = document.getElementById(sectionId);
    if (element) {
      console.log('Element found, scrolling to:', sectionId);
      element.scrollIntoView({ behavior: "smooth", block: "start" });
