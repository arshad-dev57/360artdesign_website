...
import { FaPhoneAlt, FaTimes, FaArrowUp, FaArrowRight } from "react-icons/fa";
...
export function PortfolioSection() {
  ...
  // Curated selection for the home page: featured tile + 6 supporting cards
  const filteredProjects = (activeCat === "all" ? activeProjects : activeProjects.filter(p => p.category === activeCat)).slice(0, 7);
      ...
      <section className="portfolio-section" style={{ background: "#f8f9ff", padding: "90px 40px 100px", fontFamily: "'Nunito', sans-serif" }}>
        ...
        <div style={{ textAlign: "center", marginTop: 54 }}>
          <button
            ...
            style={{ background: "transparent", color: "#e22222", border: "2px solid #e22222", padding: "14px 40px", borderRadius: 50, fontSize: 15, fontWeight: 800, fontFamily: "'Nunito', sans-serif", cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 10, transition: "all 0.25s ease" }}
            onMouseEnter={e => { e.currentTarget.style.background = "#e22222"; e.currentTarget.style.color = "#fff"; e.currentTarget.style.boxShadow = "0 12px 28px rgba(226,34,34,0.3)"; }}
            onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "#e22222"; e.currentTarget.style.boxShadow = "none"; }}
          >
            View Full Portfolio <FaArrowRight size={13} />
          </button>
        </div>
      </section>
